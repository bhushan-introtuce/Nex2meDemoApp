...
public class CreateMeetingActivity extends Nex2meGrowthActivity
    ...
    private void procceed(String meetingId){
        ...
        Call<SessionResponse> call = service.createSession(meetingId);
    ...
    private void onSessionCreate(String session,String token,String meetingid){
        ...
        Intent intent = new Intent(this,PrimaryScreenActivity.class);
        intent.putExtra(PrimaryScreenActivity.TOKEN_ID,token);
        intent.putExtra(PrimaryScreenActivity.SESSION_ID,session);
        intent.putExtra(PrimaryScreenActivity.MEETING_ID,meetingid);
